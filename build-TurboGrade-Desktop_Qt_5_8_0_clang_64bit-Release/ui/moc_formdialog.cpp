...
#include "../../TurboGrade/ui/formdialog.h"
...
QT_MOC_LITERAL(3, 19, 21), // "on_cancel_btn_clicked"
QT_MOC_LITERAL(4, 41, 17), // "on_ok_btn_clicked"
QT_MOC_LITERAL(5, 59, 13) // "select_folder"

    },
    "FormDialog\0submit\0\0on_cancel_btn_clicked\0"
    "on_ok_btn_clicked\0select_folder"
};
...
void FormDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FormDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FormDialog::submit)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FormDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FormDialog.data,
      qt_meta_data_FormDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
