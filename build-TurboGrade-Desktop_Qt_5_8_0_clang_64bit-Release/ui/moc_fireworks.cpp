...
#include "../../TurboGrade/ui/fireworks.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Fireworks_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Fireworks_t qt_meta_stringdata_Fireworks = {
    {
QT_MOC_LITERAL(0, 0, 9) // "Fireworks"
...
const QMetaObject Fireworks::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_Fireworks.data,
      qt_meta_data_Fireworks,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Fireworks::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Fireworks.stringdata0))
        return static_cast<void*>(const_cast< Fireworks*>(this));
